...
import { buildPermissionTreeNodes, clonePermissionTree, collectExpandedKeys, filterPermissionTree, flattenPermissionTree, pageTitle, permissionFields, type PermissionField } from './model/pageModel'
...
const handleSave = async () => {
  ...
  try {
    ...
    toast.add({
      severity: 'success',
      summary: 'Saved',
      detail: 'Menu permissions were saved.',
      life: 2200,
    })
  } finally {
    ...
    <template v-else>
      ...
      <div class="admin-split-layout">
        ...
        <BaseEmptyState
          ...
          description="Select a group or check service data."
        />
