...
const handleDeleteUser = () => {
  ...
  confirm.require({
    message: `${selectedUser.value.userName} will be deleted.`,
  ...
  <div class="page-stack">
    ...
    <template v-else>
      ...
      <div class="admin-split-layout">
        ...
        <BaseEmptyState
          v-if="!selectedUserId"
          :title="t('menu.users')"
          description="Select a user to manage primary affiliation."
        />
    ...
    <BaseDialog :visible="dialogVisible" :title="dialogMode === 'create' ? `${t('common.add')} ${t('menu.users')}` : `${t('common.edit')} ${t('menu.users')}`" @update:visible="dialogVisible = $event">
      <div class="form-popup-stack">
        <label class="inline-input"><span>User ID</span><InputText v-model="userForm.userId" /></label>
        <label class="inline-input"><span>User Name</span><InputText v-model="userForm.userName" /></label>
        <label class="inline-input">
          <span>Job Grade</span>
        ...
        <label class="inline-input"><span>Email</span><InputText v-model="userForm.email" /></label>
        <label class="inline-input"><span>Phone</span><InputText v-model="userForm.phone" /></label>
        <label class="inline-input"><span>Address</span><InputText v-model="userForm.address" /></label>
        <label class="inline-input"><span>Password</span><InputText v-model="userForm.password" type="password" /></label>
