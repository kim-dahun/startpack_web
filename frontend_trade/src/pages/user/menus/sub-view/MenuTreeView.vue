...
<template>
  <section class="tree-panel">
    ...
    >
      ...
      <Column field="menuUrl" :header="t('menus.field.url')">
        <template #body="slotProps">
          <span>{{ slotProps.node.data.menuUrl || t('menus.groupMenu') }}</span>
        </template>
      </Column>
      <Column field="menuLevel" :header="t('menus.field.level')" />
      <Column field="sortSeq" :header="t('menus.field.sort')" />
